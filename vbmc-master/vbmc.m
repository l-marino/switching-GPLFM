...
defopts.MaxFunEvals             = '1000 % Max number of target fcn evals';
defopts.FunEvalsPerIter         = '5            % Number of target fcn evals per iteration';
defopts.TolStableCount          = '30           % Required stable fcn evals for termination';
...
defopts.SGDStepSize             = '0.05        % Base step size for stochastic gradient descent';
...
defopts.TolStableEntropyIters   = '5            % Required stable iterations to switch entropy approximation';
...
defopts.TolLength          = '1e-4              %1e-6 Minimum fractional length scale';
...
defopts.TolFunStochastic   = '1              %1e-3 Stopping threshold for stochastic optimization';
defopts.MaxIterStochastic  = '100*(2+nvars)     % Max iterations for stochastic optimization';
defopts.TolSD              = '5               %0.1 Tolerance on ELBO uncertainty for stopping (iff variational posterior is stable)';
defopts.TolsKL             = '1  %0.01*sqrt(nvars) Stopping threshold on change of variational posterior per training point';
defopts.TolStableWarmup    = '10                %15 Number of stable fcn evals for stopping warmup';
...
defopts.CovSampleThresh    = '20                % Switch to covariance sampling below this threshold of stability index';
defopts.DetEntTolOpt       = '1e-2              % Optimality tolerance for optimization of deterministic entropy';
